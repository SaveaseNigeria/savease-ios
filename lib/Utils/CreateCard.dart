...
class _CreditCardExampleState extends State<CreateCard> {
  String cardNumber = '';
  String expiryDate = '';
  ...
  void saveCard(String cardNm,String expireDt,String cardName,String cvv)async{
    ...
    prefs.setString('cardnumber', cardNm);
    prefs.setString('expire', expireDt);
    prefs.setString('cardname', cardName);
    prefs.setString('cvv', cvv);

    Toast.show("Saving card", context, duration: Toast.LENGTH_LONG, gravity:  Toast.BOTTOM);
